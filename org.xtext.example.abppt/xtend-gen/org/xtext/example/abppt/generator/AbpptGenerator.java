...
public class AbpptGenerator extends AbstractGenerator {
  @Override
  ...
  public void generatePresentation(final Presentation presentation, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    try {
      ...
      org.xtext.example.abppt.abppt.Color _background = presentation.getTheme().getBackground();
      boolean _equals = Objects.equal(_background, org.xtext.example.abppt.abppt.Color.GREY);
      if (_equals) {
      ...
      for (final SlideContent slide : _slides) {
        {
          ...
          org.xtext.example.abppt.abppt.Color _background_1 = presentation.getTheme().getBackground();
          boolean _equals_1 = Objects.equal(_background_1, org.xtext.example.abppt.abppt.Color.GREY);
          if (_equals_1) {
