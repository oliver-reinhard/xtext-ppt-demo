...
import org.xtext.example.abppt.abppt.AbpptFactory;
 ...
 * @generated
 */
public class AbpptPackageImpl extends EPackageImpl implements AbpptPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.abppt.abppt.AbpptPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private AbpptPackageImpl()
  {
    super(eNS_URI, AbpptFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link AbpptPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static AbpptPackage init()
  {
    if (isInited) return (AbpptPackage)EPackage.Registry.INSTANCE.getEPackage(AbpptPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredAbpptPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    AbpptPackageImpl theAbpptPackage = registeredAbpptPackage instanceof AbpptPackageImpl ? (AbpptPackageImpl)registeredAbpptPackage : new AbpptPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theAbpptPackage.createPackageContents();

    // Initialize created meta-data
    theAbpptPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theAbpptPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(AbpptPackage.eNS_URI, theAbpptPackage);
    return theAbpptPackage;
  }
   ...
   */
  @Override
  public AbpptFactory getAbpptFactory()
  {
    return (AbpptFactory)getEFactoryInstance();
  }
