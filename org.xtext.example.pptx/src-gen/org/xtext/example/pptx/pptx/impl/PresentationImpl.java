 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.pptx.pptx.impl.PresentationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.pptx.pptx.impl.PresentationImpl#getTheme <em>Theme</em>}</li>
 *   <li>{@link org.xtext.example.pptx.pptx.impl.PresentationImpl#getSlides <em>Slides</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PresentationImpl extends MinimalEObjectImpl.Container implements Presentation
{
  ...
  {
    return PptxPackage.Literals.PRESENTATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PptxPackage.PRESENTATION__NAME, oldName, name));
  }
  ...
  public Theme getTheme()
  {
    if (theme != null && theme.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PptxPackage.PRESENTATION__THEME, oldTheme, theme));
      }
    }
    return theme;
  }
  ...
  public void setTheme(Theme newTheme)
  {
    ...
    theme = newTheme;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PptxPackage.PRESENTATION__THEME, oldTheme, theme));
  }
  ...
  public EList<SlideContent> getSlides()
  {
    if (slides == null)
    {
      slides = new EObjectResolvingEList<SlideContent>(SlideContent.class, this, PptxPackage.PRESENTATION__SLIDES);
    }
    return slides;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PptxPackage.PRESENTATION__NAME:
        return getName();
      case PptxPackage.PRESENTATION__THEME:
        if (resolve) return getTheme();
        return basicGetTheme();
      case PptxPackage.PRESENTATION__SLIDES:
        return getSlides();
    }
