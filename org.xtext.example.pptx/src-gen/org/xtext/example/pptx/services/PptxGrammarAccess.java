 ...
 */
package org.xtext.example.pptx.services;
...
@Singleton
public class PptxGrammarAccess extends AbstractGrammarElementFinder {
	
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.pptx.Pptx.Model");
	...
	public class SlideContentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.pptx.Pptx.SlideContent");
	...
	public class PresentationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.pptx.Pptx.Presentation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ThemeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.pptx.Pptx.Theme");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ColorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.pptx.Pptx.Color");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	@Inject
	public PptxGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.pptx.Pptx".equals(grammar.getName())) {
				return grammar;
			}
