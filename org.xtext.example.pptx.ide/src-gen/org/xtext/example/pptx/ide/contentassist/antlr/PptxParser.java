 ...
 */
package org.xtext.example.pptx.ide.contentassist.antlr;
...
import org.xtext.example.pptx.ide.contentassist.antlr.internal.InternalPptxParser;
import org.xtext.example.pptx.services.PptxGrammarAccess;

public class PptxParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(PptxGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PptxGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalPptxParser createParser() {
		InternalPptxParser result = new InternalPptxParser(null);
